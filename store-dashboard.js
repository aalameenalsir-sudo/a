...
const a=analytics||{};document.querySelector('#store-analytics-kpis').innerHTML=`<div class="kpi"><small>TOTAL VISITORS</small><b>${Number(a.total_visitors||0).toLocaleString()}</b></div><div class="kpi"><small>TODAY</small><b>${Number(a.today_visitors||0).toLocaleString()}</b></div><div class="kpi"><small>ONLINE NOW</small><b>${Number(a.online_now||0).toLocaleString()}</b></div><div class="kpi"><small>7 DAYS</small><b>${Number(a.seven_day_visitors||0).toLocaleString()}</b></div><div class="kpi"><small>30 DAYS</small><b>${Number(a.thirty_day_visitors||0).toLocaleString()}</b></div><div class="kpi"><small>PAGE VIEWS</small><b>${Number(a.page_views||0).toLocaleString()}</b></div><div class="kpi"><small>PRODUCT VIEWS</small><b>${Number(a.product_views||0).toLocaleString()}</b></div>`;
